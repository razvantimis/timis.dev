...
<CvSection title="PERSONAL PROJECTS">
 ...
 <CvExperience
  ...
  >
   ...
   <br /><br /> Github: https://github.com/razvantimis/mykineto-dissertation
  ...
  <br /> In the case of increasing heart beats for a patient with a high risk of a heart disease (as predicted by the ANN), an alert (e-mail or SMS) will be sent to the patient or to his contact person.
   <br /><br /> Github: https://github.com/razvantimis/medheart
